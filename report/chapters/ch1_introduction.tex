...
\midrule
1 & Cloud-native deterministic ingestion & Pipeline idempotency; SHA-256 deduplication pass rate & Unit tests (18 ingestion tests); repeated pipeline runs \\[4pt]
2 & Hybrid vs.\ baseline retrieval precision & Context precision (RAGAS); faithfulness $\geq 0.80$; citation grounding $> 0.80$ & Paired comparison over 25 queries; Wilcoxon signed-rank test \\[4pt]
...
Chapter~1 introduces the problem, research questions, objectives, and their mapping to evaluation metrics. Chapter~2 reviews relevant literature on Retrieval-Augmented Generation, hybrid retrieval, vector databases, and MLOps. Chapter~3 presents the methodology, hypotheses, and technical approach. Chapter~4 describes the implemented system architecture. Chapter~5 presents the evaluation framework and planned analyses. Chapter~6 documents implementation status, deviations, and engineering observations. Chapter~7 summarizes remaining work, known limitations, and the completion timeline.

\medskip
\noindent\textbf{Chapter Summary.} This chapter established the problem context, four research questions, and the core motivation for a hybrid RAG system targeting real-time technology intelligence synthesis. The following chapter reviews the technical and scientific foundations underpinning the design decisions made in this project.
