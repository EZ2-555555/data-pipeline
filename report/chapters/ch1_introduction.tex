...
\begin{enumerate}[leftmargin=0.5in]
  ...
  \item \textbf{Retrieval Optimization.} Does hybrid retrieval---combining metadata filtering, parallel vector and BM25 search, and Reciprocal Rank Fusion---improve retrieval precision and grounding faithfulness compared with baseline vector-only retrieval?
