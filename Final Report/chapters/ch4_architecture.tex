...
\caption{Six-layer conceptual architecture of TechPulse. Right-hand arrows show the upward data flow; the left-hand dashed arrow shows the query path. Layer~4 uses weighted BM25+RRF fusion with cross-encoder reranking, selected over weighted $\alpha$/$\beta$/$\gamma$ linear reranking based on design-phase analysis (Section~\ref{sec:sensitivity}).}
