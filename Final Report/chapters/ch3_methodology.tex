...
\caption{Retrieval strategy comparison: baseline (vector-only) vs. hybrid with RRF fusion. The figure illustrates the evolution of retrieval strategies and highlights the latency reduction achieved through RRF-based fusion (p95~2.44\,s) compared to earlier linear weighted reranking approaches (p95~25\,s), underscoring the necessity of parameter-free rank fusion to meet latency constraints in production settings.}
