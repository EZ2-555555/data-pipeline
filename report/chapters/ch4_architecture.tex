...
\caption{Six-layer conceptual architecture of TechPulse. Right-hand arrows show the upward data flow; the left-hand dashed arrow shows the query path. Layer~4 originally used weighted $\alpha$/$\beta$/$\gamma$ reranking; this was replaced by parameter-free BM25+RRF fusion after design-phase analysis (Section~\ref{sec:sensitivity}).}
