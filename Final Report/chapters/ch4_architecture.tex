...
% Tier 1: Groq
\node[rectangle, draw=awsorange, fill=awslightorange, rounded corners=4pt,
      minimum width=2.8cm, minimum height=0.7cm, below=0.8cm of query]
...
\draw[-{Stealth}, thick, dashed, color=awsorange!70]
  ...
  node[right, font=\scriptsize, color=awsorange!70] {retry (4x)};

% Tier 2: Bedrock (fork on Groq failure)
\node[rectangle, draw=awspurple, fill=awslightpurple, rounded corners=4pt,
      minimum width=2.8cm, minimum height=0.7cm, right=2.0cm of groq]
...
\node[rectangle, draw=awsgreen, fill=awslightgreen, rounded corners=4pt,
      minimum width=2.8cm, minimum height=0.7cm, right=2.0cm of bedrock]
...
\node[rectangle, draw=propblue!70, fill=propblue!20, rounded corners=4pt,
      minimum width=2.8cm, minimum height=0.7cm, right=2.0cm of ollama]
  (hf) {4. HuggingFace\\Mistral-7B-Instruct};
\draw[parrow, color=propred!80] (ollama.east) -- (hf.west)
  node[above, font=\scriptsize, color=propred!80] {fail};

% Fallback (all fail)
\node[rectangle, draw=propred!80, fill=propred!20, rounded corners=4pt,
      minimum width=2.8cm, minimum height=0.7cm, right=2.0cm of hf]
